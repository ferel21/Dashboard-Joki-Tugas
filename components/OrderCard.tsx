...
const OrderCard: React.FC<OrderCardProps> = ({ order, onUpdateStatus, onDeleteOrder, onEdit }) => {
  ...
  return (
    <div 
      className="bg-gray-700/50 p-4 rounded-lg shadow-md border border-gray-600/50 hover:border-indigo-500 hover:shadow-indigo-500/10 cursor-grab active:cursor-grabbing transition-all duration-200"
      draggable="true"
        ...
        <div className="relative">
          ...
          {isMenuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-10">
              <div className="py-1">
                <p className="px-4 py-2 text-xs text-gray-400">Pindahkan Ke</p>
                {STATUSES.map(status => (
                  <button
                    key={status}
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 text-left px-4 py-2 text-sm text-gray-300 hover:bg-gray-700"
                >
